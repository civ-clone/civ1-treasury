...
const getRules = () => [
    ...
    new Spend_1.default(new Criterion_1.default((cityBuild) => Object.isPrototypeOf.call(Unit_1.default, cityBuild.building())), new Criterion_1.default((cityBuild) => cityBuild.progress().value() === 0), new Effect_1.default((cityBuild, cost) => {
    ...
    new Spend_1.default(new Criterion_1.default((cityBuild) => Object.isPrototypeOf.call(CityImprovement_1.default, cityBuild.building())), new Criterion_1.default((cityBuild) => cityBuild.progress().value() === 0), new Effect_1.default((cityBuild, cost) => {
